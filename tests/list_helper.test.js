...
describe('favorite blog', () => {
    ...
    test('when list has only one blog equals the object of title, author & likes of that', () => {
...
describe('most blog', () => {
    ...
    test('when list has only one blog equals the object of author & blogs of that', () => {
...
describe('most likes', () => {
    ...
    test('when list has only one blog equals the object of author & likes of that', () => {
